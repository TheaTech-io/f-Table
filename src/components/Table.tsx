...
>(({ className, ...props }, forwardedRef) => (
  <table
    ...
    className={cn(
      ...
      // border color
      "border-gray-200 dark:border-gray-700", // Adjusted dark border
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, forwardedRef) => (
  <tbody
    ...
    className={cn(
      ...
      "divide-y",
      // divide color
      "divide-gray-200 dark:divide-gray-700", // Adjusted dark divide
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, forwardedRef) => (
  <td
    ...
    className={cn(
      ...
      "p-4 text-sm",
      // text color
      "text-gray-600 dark:text-gray-300", // Adjusted dark text
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, forwardedRef) => (
  <caption
    ...
    className={cn(
      ...
      // text color
      "text-gray-500 dark:text-gray-400", // Adjusted dark text
      className,
    )}
    {...props}
  />
